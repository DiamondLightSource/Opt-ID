...
#     b=0.0
#     x=-fullmagdims[0]/2.0
#     #z=mingap/2.0 temporary hack for catenary
#     s=-length/2.0
#     z=mingap/2.0-(a*np.cosh(s/a)-a-b)
#     V1.append((x,z,s))
...
#     s=-length/2.0
#     z=-fullmagdims[1]-mingap/2.0+(a*np.cosh(s/a)-a-b)
#     V1.append((x,z,s))
#     s+=(hemagdims[2]+interstice)
#     z=-fullmagdims[1]-mingap/2.0+(a*np.cosh(s/a)-a-b)
#     V1.append((x,z,s))
...
#     parser.add_option("--hemagdims", dest="hemagdims", help="Set the dimensions of the HE magnet blocks (x,z,s) in mm", nargs=3, default=(41., 16., 3.5), type="float")
...
#     parser.add_option("-x", "--xstartstopstep", dest="x", help="X start stop and step", nargs=3, default=(0.0, 0.1, 2.5), type="float")
#     parser.add_option("-z", "--zstartstopstep", dest="z", help="Z start stop and step", nargs=3, default=(-0.0,0.21, 0.5), type="float")
